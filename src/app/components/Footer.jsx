const footerLinks = [
  ...
  },
  {
    id: 4,
    title: "Company",
    items: ["About Us", "Press", "Contact", "Career", "Terms & Policies"],
  },
  {
    id: 5,
    title: "Follow",
...
export default function Footer() {
  return (
    <div>
      <div className="relative z-10 flex flex-row p-2 md:px-12 py-6">
            ...
            <div key={section.id} className="mb-6">
              ...
              <ul className="text-sm text-gray-600">
                {section.items.map((item, idx) => (
                  <li
                    className="hover:text-gray-400 cursor-pointer mb-2"
                    key={idx}
                  >
                    {item}
                  </li>
      ...
      <div className="w-full flex flex-row justify-between items-center text-gray-500 p-2 md:px-12 pb-4">
        <div className="w-[70px] h-fit overflow-hidden pointer-events-none">
          <div className="group w-full">
            <svg
              ...
              className="w-full h-auto transition-all duration-500 fill-[#A49CA7] group-hover:fill-[url(#footer-gradient)]"
            >
              <defs>
                <linearGradient
                  id="footer-gradient"
        ...
        <div> &copy; 2025 a serif company</div>
      </div>
    </div>
  );
}
